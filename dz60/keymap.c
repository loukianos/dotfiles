...
* |-----------------------------------------------------------------------------------------+
* | Caps  |  GUI |  Alt |                    Space               |   Alt   |  GUI  |  Del  |
* `-----------------------------------------------------------------------------------------'
*/
	...
	LAYOUT(
		...
		KC_LCTL, KC_LGUI, KC_LALT, LT(1, KC_SPC), LT(1, KC_SPC), LT(1, KC_SPC), MO(1), KC_RALT, KC_RALT, KC_LGUI, KC_DELETE),
...
*/
	...
	LAYOUT(
		...
		KC_TRNS, RGB_TOG, KC_UP, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, KC_UP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RESET,
		KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS, KC_LEFT, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS, KC_TRNS,
