...
(map! :leader
      ;;      (:prefix-map) ("l" . "language-server")
      :desc "Hover" "l h" #'lsp-ui-doc-show
      :desc "Describe" "l d" #'lsp-describe-thing-at-point
      :desc "Toggle auto-showing type" "l t" #'lsp-ui-doc-mode
      :desc "Format buffer" "l f" #'lsp-format-buffer
      :desc "Format selection" "l s" #'lsp-format-region
      )
